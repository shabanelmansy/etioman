...
class ReportsController extends Controller
{
    ...
    public function invoice($course_id='')
    {
               ...
               { 
                ...
                $objWriter->save('local/public/invoice.docx');
    ...
    public function absants($course_id='')
    {
        ...
        if($course->lanquage =="ar"){   
                ...
                foreach($students as $student)
                {
                    ...
                    $table->addCell(1000,$fancyTableCellStyle)->addText("");
                    $table->addCell(1000,$fancyTableCellStyle)->addText("");
                    $table->addCell(600,$fancyTableCellStyle)->addText($student->name_ar , array('rtl'=>true) ,  $fancyTableFontStyle);
                ...
                // Saving the document as HTML file...
                $objWriter = \PhpOffice\PhpWord\IOFactory::createWriter($phpWord, 'Word2007');
                $objWriter->save('local/public/absants_ar.docx');
