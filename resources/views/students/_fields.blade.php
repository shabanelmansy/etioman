...
{!! Form::text('name_en' ,null,['id'=>'name_en','required'=>'required','class'=>'form-control']) !!}
...
{!! Form::text('name_ar' ,null,['id'=>'name_ar','required'=>'required','class'=>'form-control']) !!}
...
<div class="form-group col-lg-6">
        {!! Form::label('Gender','Gender:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;') !!}
            ...
            @foreach ($gender as $key=>$value)
                {{ Form::radio('gender', $key, (!empty($student) ? null : ($key==session('gender', 'male') ? true : false))) }} {{ $value }}
...
{!! Form::text('organaization' ,null,['id'=>'organaization','class'=>'form-control']) !!}
...
<label>Fee</label>
{!! Form::text('fee' ,null,['id'=>'fee','class'=>'form-control']) !!}
...
<label>Mark</label>
{!! Form::text('mark' ,null,['id'=>'mark','class'=>'form-control']) !!}
...
{!! Form::text('cips_member_id' ,null,['id'=>'cips_member_id','class'=>'form-control']) !!}
...
{!! Form::text('cips_valed_to' ,null,['id'=>'cips_valed_to','class'=>'form-control']) !!}
...
{!! Form::text('cips_password' ,null,['id'=>'cips_password','class'=>'form-control']) !!}
...
{!! Form::text('cips_u1_exam_date' ,null,['id'=>'cips_u1_exam_date','class'=>'form-control']) !!}
...
{!! Form::text('cips_u1_exam_result' ,null,['id'=>'cips_u1_exam_result','class'=>'form-control']) !!}
...
{!! Form::text('cips_u2_exam_date' ,null,['id'=>'cips_u2_exam_date','class'=>'form-control']) !!}
...
{!! Form::text('cips_u2_exam_result' ,null,['id'=>'cips_u2_exam_result','class'=>'form-control']) !!}
...
{!! Form::text('cips_u3_exam_date' ,null,['id'=>'cips_u3_exam_date','class'=>'form-control']) !!}
...
{!! Form::text('cips_u3_exam_result' ,null,['id'=>'cips_u3_exam_result','class'=>'form-control']) !!}
...
{!! Form::text('cips_u4_exam_date' ,null,['id'=>'cips_u4_exam_date','class'=>'form-control']) !!}
...
{!! Form::text('cips_u4_exam_result' ,null,['id'=>'cips_u4_exam_result','class'=>'form-control']) !!}
...
{!! Form::text('cips_u5_exam_date' ,null,['id'=>'cips_u5_exam_date','class'=>'form-control']) !!}
...
{!! Form::text('cips_u5_exam_result' ,null,['id'=>'cips_u5_exam_result','class'=>'form-control']) !!}
...
{!! Form::textarea('cips_comments' ,null,['id'=>'cips_comments','class'=>'form-control','rows'=>'3']) !!}
...
{!! Form::text('cm_m1_exam_date' ,null,['id'=>'cm_m1_exam_date','class'=>'form-control']) !!}
...
{!! Form::text('cm_m1_exam_result' ,null,['id'=>'cm_m1_exam_result','class'=>'form-control']) !!}
...
{!! Form::text('cm_m2_exam_date' ,null,['id'=>'cm_m2_exam_date','class'=>'form-control']) !!}
...
{!! Form::text('cm_m2_exam_result' ,null,['id'=>'cm_m2_exam_result','class'=>'form-control']) !!}
...
{!! Form::text('cm_m3_exam_date' ,null,['id'=>'cm_m3_exam_date','class'=>'form-control']) !!}
...
{!! Form::text('cm_m3_exam_result' ,null,['id'=>'cm_m3_exam_result','class'=>'form-control']) !!}
...
<label> Comments </label>
{!! Form::textarea('cm_comments' ,null,['id'=>'cm_comments','class'=>'form-control','rows'=>'3']) !!}
...
{!! Form::text('gafm_exam_date' ,null,['id'=>'gafm_exam_date','class'=>'form-control']) !!}
...
{!! Form::text('gafm_result' ,null,['id'=>'gafm_result','class'=>'form-control']) !!}
...
<label> Comments </label>
{!! Form::textarea('gafm_comments' ,null,['id'=>'gafm_comments','class'=>'form-control','rows'=>'3']) !!}
