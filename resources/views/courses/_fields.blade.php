...
{!! Form::text('start_at' ,null,['id'=>'start_at','required'=>'required','class'=>'form-control']) !!}
...
{!! Form::text('end_at' ,null,['id'=>'end_at','required'=>'required','class'=>'form-control']) !!}
...
{!! Form::text('instructor' ,null,['id'=>'instructor','required'=>'required','class'=>'form-control']) !!}
...
<div class="form-group col-lg-6">
        {!! Form::label('lanquage','Lanquage:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;') !!}
            ...
            @foreach ($lanquage as $key=>$value)
                {{ Form::radio('lanquage', $key, (!empty($course) ? null : ($key==session('lanquageC', 'en') ? true : false))) }} {{ $value }}
...
<div class="form-group col-lg-4">
        {!! Form::label('certificate','Certificate: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;') !!}
           ...
           @foreach ($certificate as $key=>$value)
                {{ Form::radio('certificate', $key, (!empty($course) ? null : ($key==session('certificateC', 'institute') ? true : false))) }} {{ $value }}
...
{!! Form::text('duration' ,null,['class'=>'form-control',(empty($course) ? 'disabled' : ($course->certificate =='institute')?'disabled':'')]) !!}
...
<div class="form-group col-lg-4">
        {!! Form::label('organization','Organization : &nbsp;&nbsp;&nbsp;&nbsp;') !!}
            ...
            @foreach ($organization as $key=>$value)
                {{ Form::radio('organization', $key, (!empty($course) ? null : ($key==session('organizationC', 'individual') ? true : false))) }} {{ $value }}
...
{!! Form::text('org_name' ,null,['class'=>'form-control',(empty($course) ? 'disabled' : ($course->organization =='individual')?'disabled':'')]) !!}
...
<label>Fees</label>
{!! Form::text('fees' ,null,['class'=>'form-control',(empty($course) ? 'disabled' : ($course->organization =='individual')?'disabled':'')]) !!}
...
<div class="form-group col-lg-8">
        {!! Form::label('awarding_body','Awarding Body : ') !!}
            ...
            @foreach ($awarding_body as $key=>$value)
                {{ Form::radio('awarding_body', $key, (!empty($course) ? null : ($key==session('awarding_bodyC', 'local') ? true : false))) }} {{ $value }}
